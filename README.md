...
- [X] AWS overview & services
- [X] AWS Infrastructure & Regions
- [X] Security & Shared Responsibility Model
- [X] Cost Management Pricing

### 🐧 **Linux**
- [X] Working with File Systems
- [X] Managing Processes
- [X] Managing Services & Monitoring
